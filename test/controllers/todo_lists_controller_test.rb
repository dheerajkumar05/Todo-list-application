...
class TodoListsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create todo_list" do
    assert_difference("TodoList.count") do
      post todo_lists_url, params: { todo_list: { description: @todo_list.description, due_date: @todo_list.due_date, name: @todo_list.name, priority: @todo_list.priority, status: @todo_list.status } }
    end
  ...
  test "should update todo_list" do
    patch todo_list_url(@todo_list), params: { todo_list: { description: @todo_list.description, due_date: @todo_list.due_date, name: @todo_list.name, priority: @todo_list.priority, status: @todo_list.status } }
